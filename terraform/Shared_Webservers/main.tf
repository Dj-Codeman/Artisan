...
resource "proxmox_vm_qemu" "Shared-Machine" {
  count = 2
  name = "Artisan-Shared-${count.index +1}" #count.index starts at 0, so + 1 means this VM will be named test-vm-1 in proxmox
  # ${count.index + 1}
